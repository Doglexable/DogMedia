...
import MediaUploadWorkspace, { replaceMediaFilesInChunks, uploadCategoryCover, uploadMediaInChunks } from "./MediaUploadWorkspace";
    ...
    <>
      ...
      <div className="premium-app-shell" style={styles.page}>
        ...
        <main className="app-main admin-vault-main" style={{ ...styles.main, ...(player?.currentMedia ? styles.mainWithPlayer : {}) }}>
          ...
          <MobileReleaseManager
            mobileRelease={mobileRelease}
            onDelete={handleDeleteRelease}
            onFileChange={setReleaseFile}
