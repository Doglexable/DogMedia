...
export function TrackInfo({ album, artists, artist, title, media }) {
  const mediaObject = media || (title || artists || artist || album ? {
    title,
  ...
  return (
    <div className="min-w-0">
      ...
      <div className="mt-1 flex min-w-0 items-center gap-1.5 text-xs text-muted">
        <MediaArtists media={mediaObject} artists={artists || artist} />
